<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_Login.aspx.cs" Inherits="amusement_park.Admin_Login" %>
                ...
                <div class="card-body">
                    ...
                    <form id="form1" runat="server">
                        ...
                        <div class="p-t-10">
                            ...
                            <asp:Button ID="Button1" class="btn btn--pill btn--green" runat="server" Text="Login" OnClick="Button1_Click" />
